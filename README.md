...
If you want something presentable — for a business plan, a stakeholder pitch, or a project kickoff — run `/project-brief` on the session file to generate a readable markdown brief.
